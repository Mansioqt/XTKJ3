					...
					<div class="grid grid-cols-2 sm:grid-cols-3">
						<div className=" ">
							...
							<ul class="text-gray-400 dark:text-gray-400 font-medium">
								<li class="mb-2">
									<a href="https://www.instagram.com/_ciieelll/?hl=id" class="hover:underline">
										SATRIO
									</a>
								</li>
								<li>
									<a href="https://www.instagram.com/lukm_an760/?hl=id" class="hover:underline">
										LUKMAN
									</a>
								</li>
							</ul>
						...
						<div className="">
							...
							<ul class="text-gray-400 dark:text-gray-400 font-medium">
								<li class="mb-2">
									<a href="https://www.instagram.com/x.industriclass/?hl=id" class="hover:underline ">
										Instagram
									</a>
								</li>
								<li>
									<a href="https://www.tiktok.com/@x.tkjmutu/" class="hover:underline">
										Tiktok
									</a>
								</li>
							</ul>
